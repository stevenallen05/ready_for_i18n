...
describe 'TestExtractorBase' do
  it "should find a proper key for a given text/label" do
    c = Object.new
  ...
  it "should work fine with prefix" do
    c = Object.new
  ...
  it "should t_method should use string key when no use dot" do
  ...
  it "should t_method should start with a dot when use dot" do
  ...
  # it "should using keymapper when set" do
  #   mapper = Object.new
